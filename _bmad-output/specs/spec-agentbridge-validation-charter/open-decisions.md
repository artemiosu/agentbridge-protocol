...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | OQ-2A | Какие общие правила обязан сохранять любой вариант | Без этого тест можно незаметно подстроить под придуманную архитектуру | EI-01–EI-25 прошли финальный blind review с 0 Critical/High; получить осознанное re-acceptance Project Owner и freeze | Gate Chair | blind review PASS; owner re-acceptance pending |
...
1. Закрыть OQ-2 на уровне Ledger, не проектируя Candidate N.
2. Закрыть candidate-neutral часть OQ-3: oracle schema, scenario templates и holdout rules.
...
Текущее решение — OQ-2A: исправленная редакция EI-01–EI-25 прошла финальный blind review с 0 Critical/High и ожидает только re-acceptance Project Owner. Allocation Matrix уже предложена, но её Core/Profile/Binding решения остаются неблокирующими гипотезами до OQ-2B.
