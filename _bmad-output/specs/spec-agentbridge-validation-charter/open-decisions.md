...
6. **Текущий шаг:** закрыть OQ-8 и провести ранний A0 advisory; затем OQ-7B-Pilot/OQ-6B-Pilot, neutral pilot, OQ-5B/OQ-7B-Confirmatory/OQ-6B-Confirmatory, полный OQ-3B и OQ-2B; перед кодом провести формальный I2 A1 advisory.
...
OQ-2A, OQ-3A, OQ-1, OQ-4, OQ-5A, OQ-6A и OQ-7A frozen. OQ-1 после независимых проверок зафиксировал C1/C2, ANP reserve и ограниченный AGNTCY experiment, не выбрав архитектуру AgentBridge. Exact corpus остаётся OQ-3B; Allocation Matrix — гипотезой до OQ-2B. Charter и любой code сохраняют No Start.
