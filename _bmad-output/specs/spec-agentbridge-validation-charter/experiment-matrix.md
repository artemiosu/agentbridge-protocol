...
- `oracle-and-outcomes.md` — allowed/forbidden outcomes, safety projection, metamorphic properties и EI coverage;
- `scenario-corpus.md` — synthetic datasets, vector template и 65-cell public template matrix;
...
- **OQ-3A — candidate-neutral exam contract:** до Candidate N/C design принять и freeze Oracle Record, Outcome Tuple, MP-01–MP-18, DS grammars, vector template, OBS contracts и holdout-generation rule.
- **OQ-3B — exact corpus:** после зависимых OQ-4/OQ-5/OQ-8, но до любого экспериментального кода, создать и cross-check exact datasets/vectors/outcomes/calibration и sealed holdout.
...
- Каждому EI-01–EI-25 назначены positive, negative, metamorphic и observer coverage.
